...
/*   Updated: 2021/11/24 21:56:59 by vaferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incs/fdf.h"

static void	draw_arrows(t_fdf *fdf);
...
void	instructions(t_fdf *fdf)
{
	...
	rectangle(fdf, get_new_vector(400, 180, 400, 60), GREEN3);
	rectangle(fdf, get_new_vector(400, 260, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(400, 400, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(400, 539, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(400, 679, 400, 60), PINK3);
	rectangle(fdf, get_new_vector(540, 260, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(540, 400, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(540, 539, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(680, 260, 120, 120), GREY4);
	rectangle(fdf, get_new_vector(680, 400, 120, 258), GREY4);
...
static void	draw_arrows(t_fdf *fdf)
{
	plot_vector(fdf, get_new_vector(460, 450, 460, 460), ORANGE);
	plot_vector(fdf, get_new_vector(460, 480, 460, 490), ORANGE);
	plot_vector(fdf, get_new_vector(440, 470, 450, 470), ORANGE);
	plot_vector(fdf, get_new_vector(470, 470, 480, 470), ORANGE);
	plot_vector(fdf, get_new_vector(460, 450, 455, 455), ORANGE);
	plot_vector(fdf, get_new_vector(460, 450, 465, 455), ORANGE);
	plot_vector(fdf, get_new_vector(480, 470, 475, 465), ORANGE);
	plot_vector(fdf, get_new_vector(480, 470, 475, 475), ORANGE);
	plot_vector(fdf, get_new_vector(460, 490, 455, 485), ORANGE);
	plot_vector(fdf, get_new_vector(460, 490, 465, 485), ORANGE);
	plot_vector(fdf, get_new_vector(440, 470, 445, 465), ORANGE);
	plot_vector(fdf, get_new_vector(440, 470, 445, 475), ORANGE);
}
...
static void	write_instructions_a(t_fdf *fdf)
{
	...
	mlx_string_put(fdf->mlx, fdf->win, 426, 563, GREEN1, "Global Color");
